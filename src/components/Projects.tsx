...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-16 sm:py-20 px-4 sm:px-6 bg-gradient-to-br from-gray-50 to-amber-50">
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="flex flex-wrap gap-1 sm:gap-2 mb-3 sm:mb-4">
                  {project.tech.map((tech) => (
                    <span key={tech} className="px-2 sm:px-3 py-1 bg-amber-100 text-amber-800 text-xs font-medium rounded-full">
                      {tech}
                    </span>
                  ))}
                </div>
